...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Программирование не требуется! AgentBot предоставляет визуальный конструктор с готовыми шаблонами для разных ниш. Просто вставьте одну строку кода на свой сайт для активации виджета.',
  },
  {
